...
**Vías a considerar (no implementadas aún):** (a) que Unwind NUNCA banque el leg de cobertura mientras exista un perdedor core desnudo del lado opuesto; (b) evaluar el freeze de Unwind con el neto ANTES de las amputaciones del mismo tick (o correr Unwind antes que Healer); (c) acotar el presupuesto del Healer al ciclo actual, no acumulado cross-ciclo; (d) piso/floor al Healer para no amputar OP1/hedge en rojo grande. Todas chocan con "no stops duros" — requieren decisión del usuario.
